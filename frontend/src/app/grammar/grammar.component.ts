...
export class GrammarComponent implements OnInit {
  grammars = [
    ...
    { key: "きり、っきり", value: "1. Vpast + kiri = since (日本を出たっきり日本には一度も帰っていない, haven't returned to japan even once since i left) 2. N + kiri = only ソウルにいるのも今夜きりです (this is my last night in seoul)" },
    ...
    { key: "を介して", value: "をかいして　through, via, by means of, quando faccio qualcosa non direttamente ma indiriettamente" },
    { key: "を禁じ得ない　N1", value: "怒りを禁じ得ない non riesco a trattenere la rabbia. si usa sempre per roba emotiva" },
    { key: "をめぐって", value: "concerning (tipo, opinioni concerning qualcosa) モノレール建設をめぐって市民の意見が対立している (citizens' opinions are divided over the monorail construction). ha anche altre costruzioni grammaticali" },
    { key: "をものともせず", value: "in spite of (qualcosa di negativo), sostituibile con にもかかわらず" },
    { key: "思うに", value: "as far as my opinion is concerned." },
    { key: "をおいてほかに~ない", value: "there is nothing but..." },
    { key: "折に", value: "おり(に)。on the occasion, when. 上京の折は、是非お立ち寄りください (quando ti capita di venire a tokyo, passami a trovare). quando si parla di occasioni particolari da cogliere" },
    { key: "を問わず", value: "regardless (letteralmente, senza fare domande)" },
    { key: "および", value: "及び and" },
    { key: "およそ", value: "almost. strana frase: 私はおよそ名作と言われている映画はすべて観ているつもりだ i'm convinced that i've watched all the movies that are commonly considered masterpieces" },
    { key: "をおよそに　N1", value: "setting aside, ignoring... " },
    { key: "さも N1", value: "= いかにも o まるで, più o meno" },
    { key: "さぞかし　N1", value: "TODO" },
    { key: "末に", value: "すえ(に)。after, at the end of. 試行錯誤（しこうさくご）の末に、やっと出来た(after much trial and error, i succeded). nuance di hard work. occhio che è un kanji diverso da 未だに (いまだに)" },
    { key: "Vpast + なり（で）", value: "= Vpast + ままで" },
    { key: "たかが", value: "= ただの, noun modifier. means 'only'　たかが子供だ (it's just a child)" },
    { key: "たるや", value: "when it comes to, speaking of. è uguale a は, ma ha una nuance di informazione sorprendente" },
    { key: "ったって", value: "1. ても informale 2. contrazione di と言っても 3. contrazione di としても" },
    { key: "としても", value: "= にしろ/にせよ　(even though)" },
    { key: "てばかりはいられない", value: "cannot just... 過去の業績に安住してばかりはいられない (we cannot be content with our past performance)" },
    { key: "とあって", value: "because (come node e kara, ma per conseguenze naturali e ovvie)" },
    { key: "とあっては", value: "if it is true that. 社長の頼みとあっては断るわけにはいかない se è vero che è una richiesta del presidente, non posso rifiutare" },
    { key: "とばかりに", value: "as if to say. トムは「黙ってついてこい」とばかりに先に立って歩きだした tom began to walk as if to say 'don't say anything and follow me'" },
    { key: "といえども", value: "医者といえども時に病気になることもある anche i dottori a volte si ammalano (anche se li chiamiamo dottori, a volte si ammalano)" },
    { key: "XといいYといい", value: "in terms of both X and y. このコーヒーは味といい香りといい、申し分ありません this coffee is perfect in terms of both flavor and aroma" },
    { key: "といったところだ", value: "i would say. si mette questa espressione alla fine della frase" },
    { key: "ともなく N1", value: "without intending to, without paying much attention 見るともなく見る (look at something unconsciously)" },
    { key: "ともすると N1", value: "TODO" },
    { key: "ついては", value: "because of this, therefore. si usa all'inizio di una frase facendo riferimento alla frase precedente. da non confondere con については che non c'entra niente." },
    { key: "と言ったらない N1", value: "extremely (emotivamente) 悔しいと言ったらない i'm so mortified" },
    { key: "はあれ", value: "even though there is. 違いはあれ (even if there are differences...)" },
    { key: "はおろか", value: "インターネットはおろか、パソコンも触ったことがない i've never touched a computer, let alone used the internet" },
    { key: "割には", value: "値段の割には（安い割には）美味しいレストラン ristorante buono per essere cheap" },
    { key: "~わ~わ", value: "è successo questo e quello. 会議に遅れるわ名詞を忘れるわ. 客は来るわ来るわ... customers came in one after another and..." },
    { key: "や否や", value: "the moment that; no sooner than; as soon as" },
    { key: "やら", value: "だろうか、かしら、か (sentence final particle that marks a self-addressed question). si mette dopo un noun context" },
    { key: "ようでは", value: "potential + deha = if. こんな質問をするようでは、まだ勉強が足りない asking this question means that you're not studying hard enough. 高いようでは (if it's this expensive...)" },
    { key: "ようものなら", value: "遅れようものなら、se arrivi in ritardo, succedono cose brutte" },
    { key: "ようにも~ない", value: "連絡しようにもアドレスも知らない vorrei contattarlo, ma non so il suo indirizzo" },
    { key: "由 N1", value: "よし reason, significance, cause" },
    { key: "故に N1", value: "ゆえに、therefore, consequently" },
    { key: "ずにはおかない", value: "動かさずにはおかない senza dubbio farà muovere, è inevitabile" },
    { key: "ずとも", value: "anche senza --are... エアコンを使わずとも過ごせそう (quest'estate è fresca e sembra che si riuscirà a passarla senza usare l'AC)" },
  ]
